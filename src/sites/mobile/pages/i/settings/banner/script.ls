...
$ ->
	...
	function crop file
		$crop-form = $ '<form class="crop-form">
				<p>' + LOCALE.sites.mobile.pages._i._settings._banner.crop_form.title + '</p>
				<div class="container">
				</div>
				<div class="buttons">
					<button type="submit" class="ok"><i class="fa fa-check"></i>' + LOCALE.sites.mobile.pages._i._settings._banner.crop_form.ok + '</button>
					<button type="button" class="cancel"><i class="fa fa-ban"></i>' + LOCALE.sites.mobile.pages._i._settings._banner.crop_form.cancel + '</button>
				</div>
			</form>
		'
